...
- **Function Guidelines**
  ...
  - If a function needs to exceed the size limit, add:
    ```typescript
    /* ai-disable-next-function size-limit
     * Reason: This component handles complex state transitions
...
- **CSS Practices**
  ...
  - Always use Tailwind classes; avoid direct CSS
  - Use `class:` syntax over ternary operators:
    ...
    // Good
    className="bg-blue-500 class:bg-gray-500:!isActive"
    ```
